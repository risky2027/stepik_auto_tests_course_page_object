...
class LoginPageLocators():
    ...
    PASSWORD_INPUT_FOR_LOGIN = (By.CSS_SELECTOR, "id_login-password")
    ...
    PASSWORD_INPUT_FOR_REG = (By.CSS_SELECTOR, "id_registration-password1")
    PASSWORD_INPUT_FOR_CONFIRM_REG = (By.CSS_SELECTOR, "id_registration-password2")
